...
def mainPage():
    ...
    X_train, X_test, y_train, y_test = train_test_split(trainingData[0], trainingData[1], test_size=0.3,random_state=109)
    ...
    plt.plot(password,totalpassword)
    plt.title("Password Evaluator")
    plt.xlabel("Password Strength")
    plt.ylabel("Password Counts")
    plt.show()
